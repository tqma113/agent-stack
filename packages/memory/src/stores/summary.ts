/**
 * @agent-stack/memory - Summary Store
 *
...
/**
 * SQLite-based summary store
 */
export class SummaryStore extends SQLiteStore implements ISummaryStore {
  constructor() {
    super('SummaryStore');
  }
  ...
  /**
   * Convert database row to Summary
   */
  private rowToSummary(row: SummaryRow): Summary {
    return {
      id: row.id,
